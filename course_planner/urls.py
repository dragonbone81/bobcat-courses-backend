...
urlpatterns = [
    ...
    path('app/bobcat-courses', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/schedules', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/profile', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/saved-schedules', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/register', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/login', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/logout', logout, {'next_page': 'https://bobcatcourses.tk'}),
    path('app/bobcat-courses/about', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/privacy', app_privacy_view),
    path('app/bobcat-courses/waitlist', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/reset-password', RedirectView.as_view(url='https://bobcatcourses.tk')),
    path('app/bobcat-courses/forgot-password', RedirectView.as_view(url='https://bobcatcourses.tk')),
